...
$posts = array(
	array(
		...
		'content'  => '<p>いつもひだまりケア旭川をご利用いただき、ありがとうございます。</p><p>7月は、デイサービス・訪問介護ともに通常どおり営業する予定です。<br>見学やご利用に関するご相談は、平日の受付時間内にお電話またはお問い合わせフォームから承ります。</p><p>ご利用日の変更や送迎時間についてご不明な点がございましたら、担当スタッフまでお気軽にご相談ください。</p>',
	),
	array(
	...
	array(
		...
		'content'  => '<p>デイサービスの施設見学と、ご利用に関する個別相談を随時受け付けています。</p><p>ご本人やご家族の状況を伺いながら、利用までの流れやサービス内容をご説明します。事前にお電話またはお問い合わせフォームからご予約ください。</p>',
	),
	array(
		'key'      => 'news-2026-06-01',
	...
	array(
		...
		'content'  => '<p>ひだまりケア旭川の採用情報を更新しました。</p><p>仕事内容や勤務条件について詳しく知りたい方は、お問い合わせ窓口までご連絡ください。見学や事前相談も受け付けています。</p>',
	),
	array(
		'key'      => 'news-2026-05-01',
